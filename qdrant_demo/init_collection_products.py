...
def upload_embeddings():
    ...
    payload_path = os.path.join(DATA_DIR, 'product_nc.json')
    payload = []
    documents = []
    ...
    with open(payload_path) as fd:
        for line in fd:
            ...
            documents.append(obj.pop('name'))
            obj["title"] = obj.pop("title")
            obj['product_url'] = obj.pop('product_url')
            obj['price'] = obj.pop('price')
            obj["image_url"] = obj.pop("image_url")
